"""
Get Projects With Invalid Offset
"""
...
TEST_CASE = {
    "request": {
        "path_params": {},
        "query_params": {"limit": 20, "offset": -1, "sort_by": True},
...
class TestCase05GetProjectsAPIWithInvalidOffsetTestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase05GetProjectsAPIWithInvalidOffsetTestCase, self)\
