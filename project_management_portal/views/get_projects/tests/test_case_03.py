...
TEST_CASE = {
    "request": {
        "path_params": {},
        "query_params": {"limit": 26, "offset": 0, "sort_by": True},
...
class TestCase03GetProjectsAPIWithInvalidLimitTestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase03GetProjectsAPIWithInvalidLimitTestCase, self)\
