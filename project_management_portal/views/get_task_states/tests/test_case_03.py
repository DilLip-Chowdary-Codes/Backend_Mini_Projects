"""
Get Task States With Invalid Task_ID
"""
...
class TestCase03GetTaskStatesAPIWithInvalidTaskTestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase03GetTaskStatesAPIWithInvalidTaskTestCase, self)\
