"""
Create Task With Invalid State_id
"""
...
class TestCase03CreateTaskAPITestCaseWithInvalidStateId(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase03CreateTaskAPITestCaseWithInvalidStateId, self)\
