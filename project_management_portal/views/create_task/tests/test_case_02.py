"""
Create Task With Invalid Issue_Type
"""
...
class TestCase02CreateTaskAPITestCaseWithInvalidIssueType(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase02CreateTaskAPITestCaseWithInvalidIssueType, self)\
