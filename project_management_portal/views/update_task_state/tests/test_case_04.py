"""
Update Task State With Invalid Task_ID
""" 
...
class TestCase04UpdateTaskStateAPIWithInvalidTaskIDTestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase04UpdateTaskStateAPIWithInvalidTaskIDTestCase, self)\
