"""
Update Task State With Invalid Checklist
""" 
...
class TestCase02UpdateTaskStateAPIWithInvalidChecklistTestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase02UpdateTaskStateAPIWithInvalidChecklistTestCase, self)\
