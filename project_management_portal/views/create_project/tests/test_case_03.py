"""
Create Project With Invalid Project_Type
"""
...
REQUEST_BODY = """
{
    ...
    "workflow_id": 1,
    "project_type": "Classic Softwaressssss",
    "developers": []
}
"""
...
class TestCase03CreateProjectAPITestCaseWithInvalidType(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase03CreateProjectAPITestCaseWithInvalidType, self)\
