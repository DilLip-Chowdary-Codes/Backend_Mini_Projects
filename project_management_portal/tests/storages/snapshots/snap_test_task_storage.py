...
snapshots['TestTaskStorage.test_create_task task_details_dto'] = GenericRepr('TaskDetailsDto(task_id=1, project=ProjectDetailsDto(project_id=1, name=\'projectManagement\', description="it\'s a blaw blaw blaw blaw  blaw blaw ", workflow=\'Workflow_1\', project_type=\'Classic Software\', created_by_id=1, created_at=\'2020-05-28 10:06:23\', developer_ids=[1, 2]), issue_type=\'Enhancement\', title=\'Optimizing DB\', assignee_id=1, description=\'string\', state=\'State_1\')')

snapshots['TestTaskStorage.test_get_tasks tasks_details_dtos'] = [
    GenericRepr('TaskDetailsDto(task_id=2, project=ProjectDetailsDto(project_id=1, name=\'projectManagement\', description="it\'s a blaw blaw blaw blaw  blaw blaw ", workflow=\'Workflow_1\', project_type=\'Classic Software\', created_by_id=1, created_at=\'2020-05-28 10:06:23\', developer_ids=[1, 2]), issue_type=\'BUG\', title=\'Optimizing DB\', assignee_id=2, description=\'string\', state=\'State_2\')'),
    GenericRepr('TaskDetailsDto(task_id=1, project=ProjectDetailsDto(project_id=1, name=\'projectManagement\', description="it\'s a blaw blaw blaw blaw  blaw blaw ", workflow=\'Workflow_1\', project_type=\'Classic Software\', created_by_id=1, created_at=\'2020-05-28 10:06:23\', developer_ids=[1, 2]), issue_type=\'Enhancement\', title=\'Optimizing DB\', assignee_id=1, description=\'string\', state=\'State_1\')')
]
